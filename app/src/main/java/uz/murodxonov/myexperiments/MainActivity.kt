package uz.murodxonov.myexperiments
...
import uz.murodxonov.uzinput.InputPhone
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener {
            if (phoneInput.isValid()) {
                ...
                Toast.makeText(applicationContext, "Success: $fullNumber", Toast.LENGTH_SHORT).show()
            } else {
